...
- [x] **REQ-WEB-TARGET-10**: `AssemblyReferenceScanTests` via Mono.Cecil 0.11.5 (MIT) — reflective scan of Web-compiled `flow-lang.dll` asserts zero references to `Rug.Osc`, `System.IO.FileSystemWatcher`, `libpulse-simple` P/Invoke, `AudioToolbox` P/Invoke, `RtMidi.Core`. Target: Plan 47-05.
