...
Last activity: 2026-06-12 — Quick task 260611-wp2: fixed "note streams cut off after ~1 bar" (SequenceData bar-length used timesig numerator instead of actual content; monophonic overfull bars now render in full).
