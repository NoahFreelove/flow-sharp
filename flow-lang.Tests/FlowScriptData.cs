...
public static class FlowScriptData
{
    ...
    public static readonly Dictionary<string, string[]> RequiredSentinels = new()
    {
        ...
        ["test_type_ergonomics.flow"] = new[]
        {
            ...
            "PASS: up +2st transposes 2 semitones (was a crash, then 2 octaves)",
            "PASS: up 1 still transposes one octave (Int form unchanged)",
            "PASS: down +2st transposes down 2 semitones",
